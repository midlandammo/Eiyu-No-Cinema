...
<html lang="en" data-bs-theme="dark">
  <head>
	...
	<!--title of the page-->
    <title>Eiyū no Contact Us</title>
      ...
      <div class="card">
			<div class="card-body">
				<div class="row">
					...
					<center>		
						<form action = "feedbackUpload.php" method="POST">					
						<textarea  placeholder= "Please enter any feedback or suggestions you may have" name="feedback" required rows="10" cols="70"></textarea>
						<br>
						<button class="button" type="submit" class="btn btn-outline-danger">Submit</button>
						</form>	
					</center>	
					</div>
				</div>
