...
$sql = "SELECT * FROM bookings WHERE username = '". $_SESSION['account_name'] . "'";
...
<html lang="en" data-bs-theme="dark">
  <head>
	...
	<!--title of the page-->
    <title>Eiyū no Booking View</title>
							...
							<center>
								<table>
									...
									?>
										...
										<td><form action="deleteBooking.php" method="post"><?php $id = $rows['bookingID']; echo "<button type ='submit' name='count' value='$id'>Cancel</button>"?></form>
									<?php
									}
									?>
									</tr>
