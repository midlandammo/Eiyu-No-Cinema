...
<html lang="en" data-bs-theme="dark">
  <head>
	...
	<!--title of the page-->
	<title>Eiyū no Admin Add Movie</title>
	
	<!--links to styling pages-->
      ...
      <div class="card">
			<div class="card-body">
				<div class="row">
					...
					<center>					
								<form action = "movieUpload.php" method="POST">
								Title:
								...
								Dates:
								<input name="dates" required type="text"></textarea>
								<br/><br/>
								
								Showing:
								<input name="showing" required type="text"></textarea>
								<br/><br/>
								
								Price (no units):
								<input name="price" required type="text"></textarea>
								<br/><br/>
