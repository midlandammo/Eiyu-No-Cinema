...
$sql = "SELECT * FROM admin WHERE username = '". $_SESSION['admin_name'] . "'";
...
<div class="container p-5 my-5 bg-danger text-white">
	...
	<h3 class="tect-center">Welcome <?php echo htmlspecialchars($_SESSION['admin_name']); ?> </h3>
	<div class="row">
		<div class="col-sm">
					...
					<div class="row">
						<div class="form-group col-md-12">	
							<div class="d-grid gap-2 col-6 mx-auto">
								...
								<br>
								<br>
								<a href="addMovie.php" type="button" class="btn btn-danger">Add Movie</a>
								<br>
								<br>
								<a href="viewMovie.php" type="button" class="btn btn-danger">View Movies</a>
								<br>
								<br>
								<a href="deleteMovies.php" type="button" class="btn btn-danger">Delete Movies</a>
								<br>
								<br>
