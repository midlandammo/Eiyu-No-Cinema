							...
							<center>
								<table>
									...
									<form action="booker.php" method="post">
										<td><input type = "text" name = "bankCard" placeholder="Please Enter Bank Card"></td>
										<td>£ <?php $calcPrice = $rows['price'];
													$calcSeat = $rows['seatCount'];
													$price = $calcPrice * $calcSeat;
													echo $price;?></td>
										<td><button type ='submit'>Complete Purchase</button></form></td>
									</tr>
									<tr>
										<td><form action="viewCart.php"><button type ='submit'>Cancel</button></form></td>
									</tr>
									<?php
									}
									?>
