...
<div class="container p-5 my-5 bg-danger text-white">
	...
	<h3 class="tect-center">Welcome <?php echo htmlspecialchars($_SESSION['account_name']); ?> </h3>
	<div class="row">
		<div class="col-sm">
		  <div class="card">
			<div class="card-body">
					<div class="row">
						<div class="form-group col-md-12">	
							<div class="d-grid gap-2 col-6 mx-auto">
								...
								<br>
								<br>
								<a href="editUser.php" type="button" class="btn btn-danger">Edit Account</a>
								<br>
								<br>
								<a href="BookingCheck.php" type="button" class="btn btn-danger">Show Booking</a>
								<br>
								<br>
