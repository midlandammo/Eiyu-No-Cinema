...
<html lang="en" data-bs-theme="dark">
  <head>
	...
	<!--title of the page-->
    <title>Eiyū no Admin Delete</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
	 ...
	 <!--admin movie delete menu-->
	<div class="container p-5 my-5 bg-danger text-white">
	<h1 class="text-center">Delete Movies</h1>
      <div class="card">
			<div class="card-body">
				<div class="row">
					<div class="form-group col-md-12">	
								...
								<table>
									...
									<tr>
										...
										<td><form action="deleteMovie.php" method="post"><?php $id = $rows['id']; echo "<button type ='submit' name='count' value='$id'>Delete</button>"?></form>
									</tr>
									<?php
									}
									?>
