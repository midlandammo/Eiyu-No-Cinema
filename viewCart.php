  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		...
		<li class="nav-item">
          <a class="nav-link active" aria-current="page" href="viewCart.php">Cart</a>
        </li>
      </ul>
    </div>
  </div>
							...
							<center>
								<table>
									...
									?>
										...
										<td><form action="deleteCart.php" method="post"><?php $name = $rows['username']; echo "<button type ='submit' name='username' value='$name'>Empty</button>"?></form>
										<td><form action="book.php" method="post"><button type ='submit' name='count' value='$name'>Complete Purchase</button></form>
									<tr>
										<td>£ <?php $calcPrice = $rows['price'];
													$calcSeat = $rows['seatCount'];
													$truePrice = $calcPrice * $calcSeat;
													echo $truePrice;?></td>
									</tr>
									<?php
									}
